...
<div class="panel panel-default">
 ...
 on qlhs_modules.module_id = permission_user.module_id  where module_view = :view and role_user_id = :id and module_parentid = :parent order by module_order,module_id', ['id' => Auth::user()->id,'view' => 1,'parent' =>2]);
