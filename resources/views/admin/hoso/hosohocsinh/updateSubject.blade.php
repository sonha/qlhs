...
<script type="text/javascript">
  $(function () {
    ...
    $('select#drSchoolTHCD').change(function() {
      ...
      GET_INITIAL_NGHILC();
      loadUpdateDataSubject($('select#viewTableProfile').val(),$(this).val(),$('select#sltLopGrid').val(), $('#txtSearchProfile').val());
    });
    loadComboxTruongHoc("drSchoolTHCD", function(){

      loadComboxLop(47,'sltLopGrid',function(){
                closeLoading();
                 $('select#sltLopGrid').removeAttr('disabled');
                 GET_INITIAL_NGHILC();
           loadUpdateDataSubject();
              ...
              <form class="form-horizontal" action="">         
                ...
                <div class="box-body" style="font-size:12px;overflow: auto ; max-width: 100%">
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tr class="success" id="cmisGridHeader">
                          ...
                          <th  class="text-center" style="vertical-align:middle;width: 5%"><input type="checkbox" name="checkedAllChedo" id="checkedAllChedo"></th>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang cập nhật dữ liệu" class="btn btn-primary" id ="btnUpdateSubject">Chọn</button>
...
<div class="panel panel-default">
    <div class="panel-heading" id="addnew-export-profile">
       <a href="/"><b> Hồ sơ </b></a> / Cập nhật đối tượng học sinh
    </div>
</div>
