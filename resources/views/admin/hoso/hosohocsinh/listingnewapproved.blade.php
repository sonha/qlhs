...
<script type="text/javascript">
  $(function () {
    ...
    loadComboboxHocky(4, function(){});

    $('#drPagingDanhsachtonghop').change(function() {
         GET_INITIAL_NGHILC();
         loadlistUnApproved($(this).val(), $('#txtSearchProfile').val());
    });
    ...
    permission(function(){
          var html_view  = '';
          var html_view_header  = '<b> Hồ sơ </b> / Danh sách Phòng trả lại';
          
          if(check_Permission_Feature('5')){
            html_view += '<button type="button" onclick="loadlistUnApproved('+$('#drPagingDanhsachtonghop').val()+')" class="btn btn-success" id =""><i class="glyphicon glyphicon-search"></i> Xem danh sách </button>';
    ...
    // permission(function(){
    //   var html_view  = '<b> Hồ sơ </b> / Danh sách học sinh chưa phê duyệt';
    ...
    autocompleteSearch("txtSearchProfile", 4);
                ...
                <div class="box-body" style="font-size:12px;overflow: auto ; max-width: 100%">                  
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tr class="success" id="cmisGridHeader">
                          ...
                          <th  class="text-center" style="vertical-align:middle">Lý do không phê duyệt</th>
                        </tr>
                 
                      </thead>
                        <tbody id="dataListPhongRevert">                     
                        </tbody>
                    </table>
