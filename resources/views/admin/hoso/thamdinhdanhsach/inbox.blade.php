...
$(function () {
  ...
  $('select#viewthamdinh').change(function() {
       GET_INITIAL_NGHILC();
       loadInbox($(this).val());
    });
  loadInbox($('#viewthamdinh').val());

  autocompleteSearchDanhsachs("txtSearchTongHop", 1);
});
  function test(){
   $("#myModal").modal("show");
   }
    ...
    <div class="modal-dialog modal-md" style="width: 60%;margin: 30px auto;">
      ...
      <div class="modal-content box">
        ...
        <div class="box-body no-padding">
            ...
            <label style="font-weight: 500"><p id="no-file-load"></p></label>                  
              </div>
              <!-- /.mailbox-controls -->
        ...
        <input type="hidden" class="form-control" id="txtIdthamdinh">          
                <div class="modal-body">
                    ...
                    <div class="form-group" style="margin: 0;">
                      <div class="col-sm-12" style="padding-left: 0">
                         <label style="padding-top: 0px;" class="col-sm-4 control-label">Cơ quan gửi:</label>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="thamdinhClick"><i class="glyphicon glyphicon-ok"></i> Phê duyệt</button>
                         <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="chuyenlaiClick"><i class="glyphicon glyphicon-repeat"></i> Chuyển lại</button>
...
<div class="panel panel-default">
    <div class="panel-heading">
       <a href="list"> <b>Duyệt </b></a> / Danh sách hồ sơ
    </div>
    </div>
          <div class="box ">
           <section class="content">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <div class="has-feedback">
                  <input type="text" class="form-control input-sm" id="txtSearchTongHop" placeholder="Tìm kiếm văn bản">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
                      ...
                      <div class="col-md-6">
                        <select name="viewthamdinh" id="viewthamdinh"  class="form-control input-sm pagination-show-row">
