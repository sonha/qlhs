...
<script type="text/javascript">
  $(function () {
    ...
    loadComboboxHocky(2, function(){});

    $('#drPagingDanhsachtonghop').change(function() {
         GET_INITIAL_NGHILC();
         loadlistApproved($(this).val(), $('#txtSearchProfile').val(), $('#sltTrangthai').val());
    });

    $('#sltTrangthai').change(function() {
         GET_INITIAL_NGHILC();
         loadlistApproved($('#drPagingDanhsachtonghop').val(), $('#txtSearchProfile').val(), $(this).val());
    });
    ...
    permission(function(){
          var html_view  = '';
          var html_view_header  = '<b> Hồ sơ </b> / Danh sách Trường đề nghị';
          
          if(check_Permission_Feature('5')){
            html_view += '<button type="button" onclick="" class="btn btn-success" id ="btnLoadDataPhong"><i class="glyphicon glyphicon-search"></i> Xem </button>';
          }
    ...
    // permission(function(){
    //   var html_view  = '<b> Hồ sơ </b> / Danh sách chờ phê duyệt';
    ...
    autocompleteSearch("txtSearchProfile", 2);
    ...
    <div class="modal-dialog modal-md" style="width: 100%;margin: 30px auto;">
      ...
      <div class="modal-content box">
        <div class="modal-header">
          ...
          <h4 class="">Phê duyệt chế độ được hưởng</h4>
        </div>
              ...
              <form class="form-horizontal" action="">         
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="btnApprovedTHCDPheDuyet">Lưu</button>
    ...
    <div class="modal-dialog modal-md" style="width: 70%;margin: 10px auto;">
      ...
      <div class="modal-content box">
        ...
        <input type="hidden" class="form-control" id="txtIdDS">          
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="btnInsertTHCD_PheDuyet">Lập danh sách</button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Đóng</button>
                    </div>
                </div>
            </form>   
                ...
                <!-- <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center" id="event-thcd">
                            <button type="button" onclick="" class="btn btn-success" id ="btnLoadDataPhong"><i class="glyphicon glyphicon-search"></i> Xem danh sách</button>
                            ...
                            <button type="button" onclick="approvedAllPheDuyet()" class="btn btn-success" id =""><i class="glyphicon glyphicon-pencil"></i> Phê duyệt toàn bộ</button>
                            <button type="button" onclick="unApprovedAllPheDuyet()" class="btn btn-success" id =""><i class="glyphicon glyphicon-pencil"></i> Hủy phê duyệt toàn bộ</button>
                        </div>
                    </div>
                  </div>
            </form>
                        ...
                        <tr class="success" id="cmisGridHeader">
                          ...
                          <th  class="text-center" colspan="2" style="vertical-align:middle">
                            <select name="sltTrangthai" id="sltTrangthai">
                              ...
                              <option value="CHO">Chờ phê duyệt</option>
                              <option value="DA">Đã phê duyệt</option>
                            </select>
                          </th>
                        </tr>
