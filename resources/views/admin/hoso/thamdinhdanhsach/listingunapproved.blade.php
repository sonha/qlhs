...
<script type="text/javascript">
  $(function () {
    ...
    loadComboboxHocky(5, function(){});

    $('#drPagingDanhsachtonghop').change(function() {
         GET_INITIAL_NGHILC();
         loadlistUnApprovedThamdinh($(this).val(), $('#txtSearchProfile').val());
    });
    ...
    permission(function(){
          var html_view  = '';
          var html_view_haeder  = '<b> Hồ sơ </b> / Danh sách Sở trả lại';

          if(check_Permission_Feature('5')){
            html_view += '<button type="button" onclick="loadlistUnApprovedThamdinh('+$('#drPagingDanhsachtonghop').val()+')" class="btn btn-success" id =""><i class="glyphicon glyphicon-search"></i> Xem danh sách </button>';
          }
          ...
          // }
          $('#addnew-export-profile').html(html_view_haeder);
          $('#event-thcd').html(html_view);
      }, 96);

    // permission(function(){
    //   var html_view  = '<b> Hồ sơ </b> / Danh sách chưa thẩm định';
    ...
    autocompleteSearch("txtSearchProfile", 5);
                  ...
                  <div class="form-group " style="margin-top: 10px;margin-bottom: 10px">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tr class="success" id="cmisGridHeader">
                          ...
                          <th  class="text-center" style="vertical-align:middle">Lý do không thẩm định</th>

                          <!-- <th  class="text-center" style="vertical-align:middle">Chức năng</th> -->
                        </tr>
                 
                      </thead>
                        <tbody id="dataListUnApprovedSo">                     
                        </tbody>
                    </table>
