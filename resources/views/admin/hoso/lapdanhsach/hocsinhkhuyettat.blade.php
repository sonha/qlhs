...
$(function () {
  ...
  $("#exampleInputFileHSKT").filestyle({
    buttonText : 'Đính kèm',
    buttonName : 'btn-info'
  });
  loadComboxTruongHoc();
  ...
  $('#drPagingHSKT').change(function() {
       GET_INITIAL_NGHILC();
       loaddataHSKT($(this).val());
    });
  ...
  permission(function(){
        ...
        html_view += '<button type="button" onclick="resetHSKT()" class="btn btn-primary" id ="btnCancelHSKT"><i class="glyphicon glyphicon-refresh"></i>Làm mới</button>';
        // if(check_Permission_Feature('5')){
        //     html_view += '<button type="button" class="btn btn-info" id ="btnSendHSKT"><i class="glyphicon glyphicon-send"></i>Gửi danh sách</button>';
        // }
        $('#event-HSKT').html(html_view);
    });
  loaddataHSKT($('#drPagingHSKT').val());
});
   function myModalLapDanhSach(){
    var message = "";
    message = validateHSKT();
    if (message !== "") {
  ...
  function openPopupSendHSKT(){
    ...
    $("#myModalSendHSKT").modal("show");
  }
  
</script>

<div class="modal fade" id="myModalRevertHSKT" role="dialog">
...
<div class="modal fade" id="myModalSendHSKT" role="dialog">
        ...
        <input type="hidden" class="form-control" id="txtIdDS">          
                ...
                <div class="form-group">
                  <div class="col-sm-4" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtNameDSHSKT" placeholder="Nhập tên danh sách">
                    </div>
                  </div>
                  <div class="col-sm-4" style="padding-left: 0">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" id="txtNguoiLapHSKT" placeholder="Nhập tên người lập">
                  </div>
                  </div>
                  <div class="col-sm-4" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtNguoiKyHSKT" placeholder="Nhập tên người tạo">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-12" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtGhiChuHSKT" placeholder="Nhập ghi chú">
                    </div>
                  </div>
                </div>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="btnInsertHSKT">Thêm mới</button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Đóng</button>
                    </div>
                </div>
            </form>   
...
<div class="panel panel-default">
    <div class="panel-heading">
       <a href="/ho-so/lap-danh-sach/list"><b> Hồ sơ </b></a> / Chính sách hỗ trợ học sinh khuyết tật
    </div>
</div>
    <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formhskt">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-5">
                      ...
                      <div class="col-sm-8">
                        <select name='drStatusHSKT' class="form-control" id='drStatusHSKT'>
                     ...
                     <div class="col-sm-5">
                      ...
                      <div class="col-sm-8">
                      <input style="margin-top: 2px;" type="file" id="exampleInputFileHSKT">
                      </div>
                    </div>
                </div>

                 <div class="modal-footer">
                        <div class="row text-center" id="event-HSKT">
                    ...
                    <div class="box-footer clearfix">
                      <div class="row">
                          ...
                          <div class="col-md-3">
                                        ...
                                        <div class="col-md-6">
                                          <select name="drPagingHSKT" id="drPagingHSKT"  class="form-control input-sm pagination-show-row">
