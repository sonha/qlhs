...
$(function () {
  ...
  permission(function(){
        ...
        // }
        $('#ex-chiphihoctap').html(html_view);
    });
  loaddataAll($('select#view-chiphihoctap').val(),'CPHT','dataChiPhiHocTap');
});
   function myModalLapDanhSach(){
    if(parseInt($('#sltSchool').val()) != 0){
        if($('#sltYear').val() != ""){
          ...
          $('#txtNguoiKy').val('');
          $('#txtGhiChuCPHT').val('');
            $("#myModalLapDanhSachCPHT").modal("show");  
        }else{
  ...
  function openPopupSendCPHT(){
    ...
    $("#myModalSendCPHT").modal("show");
  }
  
</script>

<div class="modal fade" id="myModalRevertCPHT" role="dialog">
...
<div class="modal fade" id="myModalSendCPHT" role="dialog">
...
<div class="modal fade" id="myModalLapDanhSachCPHT" role="dialog">
    <div class="modal-dialog modal-md" style="width: auto;margin: 10px;">
        ...
        <input type="hidden" class="form-control" id="txtIdDS">          
                ...
                <div class="form-group">
                  <div class="col-sm-12" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtGhiChuCPHT" placeholder="Nhập ghi chú">
                    </div>
                  </div>
                </div>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="save2">Thêm mới</button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Đóng</button>
                    </div>
                </div>
            </form>   
...
<div class="panel panel-default">
    <div class="panel-heading">
       <a href="/ho-so/lap-danh-sach/list"><b> Hồ sơ </b></a> / Hỗ trợ chi phí học tập
    </div>
</div>
    <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="frmCPHT">
            <div class="row" id="warning_msg" style="padding-left: 10%;padding-right: 10%"></div>
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center" id="ex-chiphihoctap">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
                      ...
                      <div class="col-md-6">
                        <select name="view-chiphihoctap" id="view-chiphihoctap"  class="form-control input-sm pagination-show-row">
