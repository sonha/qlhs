...
$(function () {
  ...
  $("#exampleInputFileNGNA").filestyle({
    buttonText : 'Đính kèm',
    buttonName : 'btn-info'
  });
  loadComboxTruongHoc();
  ...
  $('#drPagingNGNA').change(function() {
       GET_INITIAL_NGHILC();
       loaddataNGNA($(this).val());
    });
  ...
  permission(function(){
        ...
        html_view += '<button type="button" onclick="resetNGNA()" class="btn btn-primary" id =""><i class="glyphicon glyphicon-refresh"></i> Làm mới</button>';
...
<div class="modal fade" id="myModalRevertNGNA" role="dialog">
...
<div class="modal fade" id="myModalSendNGNA" role="dialog">
        ...
        <input type="hidden" class="form-control" id="txtIdDS">          
                ...
                <div class="form-group">
                  <div class="col-sm-4" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtNameDSNGNA" placeholder="Nhập tên danh sách">
                    </div>
                  </div>
                  <div class="col-sm-4" style="padding-left: 0">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" id="txtNguoiLapNGNA" placeholder="Nhập tên người lập">
                  </div>
                  </div>
                  <div class="col-sm-4" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtNguoiKyNGNA" placeholder="Nhập tên người ký">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-12" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtGhiChuNGNA" placeholder="Nhập ghi chú">
                    </div>
                  </div>
                </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
       <a href="/ho-so/lap-danh-sach/list"><b> Hồ sơ </b></a> / Hỗ trợ người nấu ăn
    </div>
</div>
    <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formngna">
            <div class="row" id="messageValidate" style="padding-left: 10%;padding-right: 10%"></div> 
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center" id="event-ngna">
                    ...
                    <div class="box-footer clearfix">
                      <div class="row">
                          ...
                          <div class="col-md-3">
                                        ...
                                        <div class="col-md-6">
                                          <select name="drPagingNGNA" id="drPagingNGNA"  class="form-control input-sm pagination-show-row">
