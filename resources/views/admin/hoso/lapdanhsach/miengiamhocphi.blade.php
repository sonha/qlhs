...
$(function () {
  $('select#view-miengiamhocphi').change(function() {
       GET_INITIAL_NGHILC();
       loaddata($(this).val());
    });
  ...
  permission(function(){
        ...
        // }
        $('#ex-miengiamhocphi').html(html_view);
    });
  loadComboxTruongHoc();
  loadComboxNamHoc();
...
<div class="modal fade" id="myModalSendMGHP" role="dialog">
...
<div class="panel panel-default">
    <div class="panel-heading">
       <a href="/ho-so/lap-danh-sach/list"><b> Hồ sơ </b></a> / Hỗ trợ chính sách miễn giảm học phí
            ...
            <div class="row" id="warning_msg" style="padding-left: 10%;padding-right: 10%"></div>
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center" id="ex-miengiamhocphi">
                        </div>
                    </div>
              </div>
            </form>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
                      ...
                      <div class="col-md-6">
                        <select name="view-miengiamhocphi" id="view-miengiamhocphi"  class="form-control input-sm pagination-show-row">
