...
$(function () {
  ...
  $("#exampleInputFileHTBT").filestyle({
    buttonText : 'Đính kèm',
    buttonName : 'btn-info'
  });
  loadComboxTruongHoc();
  ...
  $('#drPagingHTBT').change(function() {
       GET_INITIAL_NGHILC();
       loaddataHTBT($(this).val());
    });
  ...
  permission(function(){
        ...
        html_view += '<button type="button" onclick="resetHTBT()" class="btn btn-primary" id ="btnCancelHTBT"><i class="glyphicon glyphicon-refresh"></i>Làm mới</button>';
        // if(check_Permission_Feature('5')){
        //     html_view += '<button type="button" class="btn btn-info" id ="btnSendHTBT"><i class="glyphicon glyphicon-send"></i>Gửi danh sách</button>';
        // }
        $('#event-htbt').html(html_view);
    });
  loaddataHTBT($('#drPagingHTBT').val());
});
   function myModalLapDanhSach(){
    var message = "";
    message = validateHTBT();
    if (message !== "") {
  ...
  function openPopupSendHTBT(){
    ...
    $("#myModalSendHTBT").modal("show");
  }
  
</script>

<div class="modal fade" id="myModalRevertHTBT" role="dialog">
...
<div class="modal fade" id="myModalSendHTBT" role="dialog">
        ...
        <input type="hidden" class="form-control" id="txtIdDS">          
                ...
                <div class="form-group">
                  <div class="col-sm-4" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtNameDSHTBT" placeholder="Nhập tên danh sách">
                    </div>
                  </div>
                  <div class="col-sm-4" style="padding-left: 0">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" id="txtNguoiLapHTBT" placeholder="Nhập tên người lập">
                  </div>
                  </div>
                  <div class="col-sm-4" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtNguoiKyHTBT" placeholder="Nhập tên người ký">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12" style="padding-left: 0">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="txtGhiChuHTBT" placeholder="Nhập ghi chú">
                    </div>
                  </div>
                </div>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang thêm mới dữ liệu" class="btn btn-primary" id ="btnInsertHTBT">Thêm mới</button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Đóng</button>
                    </div>
                </div>
            </form>   
...
<div class="panel panel-default">
    <div class="panel-heading">
       <a href="/ho-so/lap-danh-sach/list"><b> Hồ sơ </b></a> / Hỗ trợ học sinh bán trú
    </div>
</div>
    <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formhtbt">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-5">
                      ...
                      <div class="col-sm-8">
                        <select name='drStatusHTBT' class="form-control" id='drStatusHTBT'>
                     ...
                     <div class="col-sm-5">
                      ...
                      <div class="col-sm-8">
                      <input style="margin-top: 2px;" type="file" id="exampleInputFileHTBT">
                      </div>
                    </div>
                </div>

                 <div class="modal-footer">
                        <div class="row text-center" id="event-htbt">
                    ...
                    <div class="box-footer clearfix">
                      <div class="row">
                          ...
                          <div class="col-md-3">
                                        ...
                                        <div class="col-md-6">
                                          <select name="drPagingHTBT" id="drPagingHTBT"  class="form-control input-sm pagination-show-row">
