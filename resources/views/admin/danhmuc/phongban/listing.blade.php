                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="txtWardCodePopup" placeholder="Nhập mã địa phương">
                                  </div>
                                </div>
                                <div class="form-group">
        ...
        <div class="col-md-7">
          ...
          <div class="box box-info">
            ...
            <input type="hidden" id="txtWardID" name="">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Mã loại xã</label>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Tên loại xã</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center">
                            ...
                            <button type="reset" class="btn btn-primary" data-dismiss="modal">Làm mới</button>
                        </div>
                    </div>
            </form>
          </div>
