...
class LapHoSoSoController extends Controller
{

//------------------------------------------------------Lập danh sách--------------------------------------------------------------------
    public function lapdanhsachTHCD_thamdinh(Request $request){
        try {
...
//---------------------------------------------------------------------MGHP------------------------------------------------------------------------
    public function miengiamhocphi($truong, $namhoc, $note, $report_name, $report_user_sign, $user_name, $status){
        ...
        $data1 = DB::table('qlhs_profile')
            ...
            ->select('kp1.money as money1','kp2.money as money2','profile_id','profile_name','profile_year', 'level_old', 'level_cur', 'level_new', 'yearold.ThamDinh_trangthai_MGHP as old_MGHP', 'yearold.ThamDinh_trangthai_MGHP_HK2 as old_MGHP_HK2', 'yearcur.ThamDinh_trangthai_MGHP as cur_MGHP', 'yearcur.ThamDinh_trangthai_MGHP_HK2 as cur_MGHP_HK2',
            ...
            // ->where('qlhs_thcd_nam', '=', DB::raw(($namhoc - 1).' and (ThamDinh_trangthai_MGHP = 1 or ThamDinh_trangthai_MGHP_HK2 = 1)'))
            
            ->groupBy('profile_id','profile_name','profile_year','level_old','level_cur','level_new','kp1.money','kp2.money', 'yearold.ThamDinh_trangthai_MGHP', 'yearold.ThamDinh_trangthai_MGHP_HK2', 'yearcur.ThamDinh_trangthai_MGHP', 'yearcur.ThamDinh_trangthai_MGHP_HK2');
        ...
        $data2 = DB::table('qlhs_profile')
            ...
            ->where('profile_school_id','=',$truong)
            ->whereIn('profile_subject_subject_id',[28,35,36,73,38,39,34,40,41,74,49])
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($namhoc.' and (yearcur.ThamDinh_trangthai_MGHP = 1 or yearcur.ThamDinh_trangthai_MGHP_HK2 = 1)'))
            ->groupBy('profile_id','profile_name','profile_year','level_old','level_cur','level_new','kp1.money','kp2.money', 'yearold.ThamDinh_trangthai_MGHP', 'yearold.ThamDinh_trangthai_MGHP_HK2', 'yearcur.ThamDinh_trangthai_MGHP', 'yearcur.ThamDinh_trangthai_MGHP_HK2');
...
//---------------------------------------------------------------------CPHT------------------------------------------------------------------------
    public function chiphihoctap($truong, $namhoc, $note, $report_name, $report_user_sign, $user_name, $status){
        try {
            ...
            ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($namhoc - 1).' and (yearold.ThamDinh_trangthai_CPHT = 1 or yearold.ThamDinh_trangthai_CPHT_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$namhoc.' and (yearcur.ThamDinh_trangthai_CPHT = 1 or yearcur.ThamDinh_trangthai_CPHT_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearnew', 'yearnew.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearnew.qlhs_thcd_nam = '.($namhoc + 1)))
            ...
            ->select('profile_id','profile_name','profile_year', 'level_old','level_cur','level_new', 
                ...
                DB::raw("MAX(
                    CASE
                        ...
                        ) AND kp.months in (1,2,3,4,5) AND kp.years = ".$namhoc." AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_CPHT_HK2 = 1) 
                        OR (level_cur <> ''
                        ...
                        ) AND kp.months in (9,10,11,12) AND kp.years = ".$namhoc." AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_CPHT = 1)  THEN
                        kp.value_m
                        ELSE
                            0
                        END
                ...
                DB::raw("MAX(
                    CASE
                        ...
                        ) AND kp.months in (1,2,3,4,5) AND kp.years = ".($namhoc + 1)." AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_CPHT_HK2 = 1)  
                        OR (level_new <> ''
            ...
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($namhoc.' and (yearcur.ThamDinh_trangthai_CPHT = 1 or yearcur.ThamDinh_trangthai_CPHT_HK2 = 1 or yearold.ThamDinh_trangthai_CPHT = 1 or yearold.ThamDinh_trangthai_CPHT_HK2 = 1)'))
            ...
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($namhoc.' and (yearcur.ThamDinh_trangthai_CPHT = 1 or yearcur.ThamDinh_trangthai_CPHT_HK2 = 1)'))
...
//---------------------------------------------------------------------HTAT------------------------------------------------------------------------
    public function hoTroAnTruaTreEm($truong, $namhoc, $note, $report_name, $report_user_sign, $user_name, $status){
        ...
        ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($namhoc - 1).' and (yearold.ThamDinh_trangthai_HTAT = 1 or yearold.ThamDinh_trangthai_HTAT_HK2 = 1)'))
        // ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', 'profile_id')
        ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$namhoc.' and (yearcur.ThamDinh_trangthai_HTAT = 1 or yearcur.ThamDinh_trangthai_HTAT_HK2 = 1)'))
        ->leftJoin('qlhs_tonghopchedo as yearnew', 'yearnew.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearnew.qlhs_thcd_nam = '.($namhoc + 1)))
        ->select('profile_id','profile_name','profile_year', 'level_old','level_cur','level_new', 
            DB::raw('MAX(profile_subject_subject_id) as profile_subject_subject_id'),
            ...
            DB::raw("MAX(CASE when level_new <> '' and qlhs_profile.profile_year < '".($namhoc +1)."-12-31' and profile_subject_subject_id in (73,26,34,28,41,74) and (profile_leaveschool_date is null or (profile_leaveschool_date >= '".((int)$namhoc+1)."-05-31')) then 1 else 0 END) 'HKI3'"),
                DB::raw("MAX(
                    CASE
                        ...
                        ) AND kp.months in (1,2,3,4,5) AND kp.years = ".$namhoc." AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HTAT_HK2 = 1) 
                        OR (level_cur <> ''
                        AND qlhs_profile.profile_year < '".$namhoc."-12-31'
                        AND profile_subject_subject_id IN (73,26,34,28,41,74)
                        AND (
                        ...
                        ) AND kp.months in (9,10,11,12) AND kp.years = ".$namhoc." AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HTAT = 1)  THEN
                        kp.value_m
                        ELSE
                            0
                        END
                ...
                DB::raw("MAX(
                    CASE
                        ...
                        ) AND kp.months in (1,2,3,4,5) AND kp.years = ".($namhoc + 1)." AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HTAT_HK2 = 1) 
                        OR (level_new <> ''
                        AND qlhs_profile.profile_year < '".($namhoc + 1)."-12-31'
                        AND profile_subject_subject_id IN (73,26,34,28,41,74)
                        AND (
        ...
        // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($namhoc.' and (yearcur.ThamDinh_trangthai_HTAT = 1 or yearcur.ThamDinh_trangthai_HTAT_HK2 = 1 or yearold.ThamDinh_trangthai_HTAT = 1 or yearold.ThamDinh_trangthai_HTAT_HK2 = 1)'))
        ->groupBy('profile_id','profile_name','profile_year','level_old','level_cur','level_new','kp.value_m','kp.months','kp.years');
        ...
        ->where('profile_school_id','=',$truong)
        ->whereIn('profile_subject_subject_id',[73,26,34,28,41,74])
        // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($namhoc.' and (yearcur.ThamDinh_trangthai_HTAT = 1 or yearcur.ThamDinh_trangthai_HTAT_HK2 = 1)'))
        ->groupBy('profile_id','profile_name','profile_year','level_old','level_cur','level_new','kp.value_m','kp.months','kp.years');
...
//---------------------------------------------------------------------HTBT------------------------------------------------------------------------
    public function getDataHTBT($school_id, $year, $report_name, $user_sign, $user_create, $note, $status){
        ...
        try {
            ...
            ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($year - 1).' and (yearold.ThamDinh_trangthai_HTBT_TA = 1 or yearold.ThamDinh_trangthai_HTBT_TO = 1 or yearold.ThamDinh_trangthai_HTBT_VHTT = 1 or yearold.ThamDinh_trangthai_HTBT_TA_HK2 = 1 or yearold.ThamDinh_trangthai_HTBT_TO_HK2 = 1 or yearold.ThamDinh_trangthai_HTBT_VHTT_HK2 = 1)'))
            // ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', 'profile_id')
            ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$year.' and (yearcur.ThamDinh_trangthai_HTBT_TA = 1 or yearcur.ThamDinh_trangthai_HTBT_TO = 1 or yearcur.ThamDinh_trangthai_HTBT_VHTT = 1 or yearcur.ThamDinh_trangthai_HTBT_TA_HK2 = 1 or yearcur.ThamDinh_trangthai_HTBT_TO_HK2 = 1 or yearcur.ThamDinh_trangthai_HTBT_VHTT_HK2 = 1)'))
            ...
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai = 1 or yearcur.ThamDinh_trangthai_HK2 = 1 or yearold.ThamDinh_trangthai = 1 or yearold.ThamDinh_trangthai_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                ...
                DB::raw('MAX(CASE when qlhs_profile_history.level_new <> "" and qlhs_profile.profile_year < "'.($year +1).'-12-31" and (qlhs_profile.profile_leaveschool_date is null or ( qlhs_profile.profile_leaveschool_date > "'.($year + 1).'-05-31")) then 1 else 0 END) as hotroVHTT_hocky1_new'),
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 94 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HTBT_TA_HK2 = 1) 
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 94 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HTBT_TA = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 98 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HTBT_TO_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id in (34, 46)
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 98 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HTBT_TO = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 115 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HTBT_VHTT_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 46
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 115 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HTBT_VHTT = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            AND kp.months in (1,2,3,4,5) and kp.years = '.($year +1).' AND kp.id_doituong = 94 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HTBT_TA_HK2 = 1) 
                    ...
                    DB::raw('MAX(
                            ...
                            AND kp.months in (1,2,3,4,5) and kp.years = '.($year +1).' AND kp.id_doituong = 98 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HTBT_TO_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id in (34, 46)
                            AND qlhs_profile.profile_year < "'.($year +1).'-12-31"
                            AND (
                    ...
                    DB::raw('MAX(
                            ...
                            AND kp.months in (1,2,3,4,5) and kp.years = '.($year +1).' AND kp.id_doituong = 115 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HTBT_VHTT_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 46
                            AND qlhs_profile.profile_year < "'.($year +1).'-12-31"
                            AND (
            ...
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai = 1 or yearcur.ThamDinh_trangthai_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                DB::raw('MAX(CASE when qlhs_profile_subject.profile_subject_subject_id in (34, 46) then 1 else 0 END) as hotrotienan'), 
                DB::raw('MAX(CASE when qlhs_profile_subject.profile_subject_subject_id in (34, 46) then 1 else 0 END) as hotrotieno'), 
                DB::raw('MAX(CASE when qlhs_profile_subject.profile_subject_subject_id = 46 then 1 else 0 END) as hotroVHTT'), 
...
//---------------------------------------------------------------------HSKT------------------------------------------------------------------------
    public function getDataHSKT($school_id, $year, $report_name, $user_sign, $user_create, $note, $status){
        ...
        try {
            ...
            ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($year - 1).' and (yearold.ThamDinh_trangthai_HSKT_HB = 1 or yearold.ThamDinh_trangthai_HSKT_DDHT = 1 or yearold.ThamDinh_trangthai_HSKT_HB_HK2 = 1 or yearold.ThamDinh_trangthai_HSKT_DDHT_HK2 = 1)'))
            // ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', 'profile_id')
            ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$year.' and (yearcur.ThamDinh_trangthai_HSKT_HB = 1 or yearcur.ThamDinh_trangthai_HSKT_DDHT = 1 or yearcur.ThamDinh_trangthai_HSKT_HB_HK2 = 1 or yearcur.ThamDinh_trangthai_HSKT_DDHT_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearnew', 'yearnew.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearnew.qlhs_thcd_nam = '.($year + 1)))
            ->where('qlhs_profile.profile_school_id', '=', $school_id)
            ->where('qlhs_profile.profile_year', '<', $year.'-06-01')
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai = 1 or yearcur.ThamDinh_trangthai_HK2 = 1 or yearold.ThamDinh_trangthai = 1 or yearold.ThamDinh_trangthai_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                ...
                DB::raw('(CASE when qlhs_profile_history.level_new <> "" and qlhs_profile.profile_year < "'.($year + 1).'-12-31" and (qlhs_profile.profile_leaveschool_date is null or ( qlhs_profile.profile_leaveschool_date > "'.($year + 1).'-05-31")) then 1 else 0 END) as hotro_hocky1_new'),
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 95 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HSKT_HB_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 74
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 95 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HSKT_HB = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 100 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HSKT_DDHT_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 74
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 100 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HSKT_DDHT = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            AND kp.months in (1,2,3,4,5) and kp.years = '.($year +1).' AND kp.id_doituong = 95 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HSKT_HB_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 74
                            AND qlhs_profile.profile_year < "'.($year +1).'-12-31"
                            AND (
                    ...
                    DB::raw('MAX(
                            ...
                            AND kp.months in (1,2,3,4,5) and kp.years = '.($year +1).' AND kp.id_doituong = 100 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HSKT_DDHT_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 74
                            AND qlhs_profile.profile_year < "'.($year +1).'-12-31"
                            AND (
...
//---------------------------------------------------------------------HSDTTS------------------------------------------------------------------------
    public function getDataHSDTTS($school_id, $year, $report_name, $user_sign, $user_create, $note, $status){
        ...
        try {
            ...
            ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($year - 1).' and (yearold.ThamDinh_trangthai_HSDTTS = 1 or yearold.ThamDinh_trangthai_HSDTTS_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$year.' and (yearcur.ThamDinh_trangthai_HSDTTS = 1 or yearcur.ThamDinh_trangthai_HSDTTS_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearnew', 'yearnew.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearnew.qlhs_thcd_nam = '.($year + 1)))
            ->where('qlhs_profile.profile_school_id', '=', $school_id)
            ->where('qlhs_profile.profile_year', '<', $year.'-06-01')
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_school_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                ...
                DB::raw('(CASE when qlhs_profile_history.level_new <> "" and qlhs_profile.profile_year < "'.($year + 1).'-12-31" and (qlhs_profile.profile_leaveschool_date is null or ( qlhs_profile.profile_leaveschool_date > "'.($year + 1).'-05-31")) then 1 else 0 END) as hocky1_new'),
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 99 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HSDTTS_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                                qlhs_profile.profile_leaveschool_date IS NULL
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 99 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HSDTTS = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.($year + 1).' AND kp.id_doituong = 99 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HSDTTS_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile.profile_year < "'.($year + 1).'-12-31"
                            AND (
                                qlhs_profile.profile_leaveschool_date IS NULL
            ...
            ->where('qlhs_profile.profile_year', '>', $year.'-05-31')
            ->where('qlhs_profile.profile_year', '<', ($year + 1).'-06-01')
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai_HSDTTS = 1 or yearcur.ThamDinh_trangthai_HSDTTS_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_school_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                DB::raw('MAX(CASE when qlhs_profile_subject.profile_subject_subject_id = 49 then 1 else 0 END) as hotrokinhphi'), 
...
//---------------------------------------------------------------------HTATHS------------------------------------------------------------------------
    public function getDataHTATHS($school_id, $year, $report_name, $user_sign, $user_create, $note, $status){
        ...
        try {
            ...
            ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($year - 1).' and (yearold.ThamDinh_trangthai_HTATHS = 1 or yearold.ThamDinh_trangthai_HTATHS_HK2 = 1)'))
            // ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', 'profile_id')
            ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$year.' and (yearcur.ThamDinh_trangthai_HTATHS = 1 or yearcur.ThamDinh_trangthai_HTATHS_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearnew', 'yearnew.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearnew.qlhs_thcd_nam = '.($year + 1)))
            ->where('qlhs_profile.profile_school_id', '=', $school_id)
            ->where('qlhs_profile.profile_year', '<', $year.'-06-01')
            ->where('qlhs_profile.profile_statusNQ57', '=', 1)
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai_HTATHS = 1 or yearcur.ThamDinh_trangthai_HTATHS_HK2 = 1 or yearold.ThamDinh_trangthai_HTATHS = 1 or yearold.ThamDinh_trangthai_HTATHS_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_school_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                ...
                DB::raw('(CASE when qlhs_profile_history.level_new <> "" and qlhs_profile.profile_year < "'.($year + 1).'-12-31" and (qlhs_profile.profile_leaveschool_date is null or ( qlhs_profile.profile_leaveschool_date > "'.($year + 1).'-05-31")) then 1 else 0 END) as hocky1_new'),
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 118 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HTATHS_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 69
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 118 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HTATHS = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.($year + 1).' AND kp.id_doituong = 118 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HTATHS_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 69
                            AND qlhs_profile.profile_year < "'.($year + 1).'-12-31"
                            AND (
            ...
            ->where('qlhs_profile.profile_year', '<', ($year + 1).'-06-01')
            ->where('qlhs_profile.profile_statusNQ57', '=', 1)
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai_HTATHS = 1 or yearcur.ThamDinh_trangthai_HTATHS_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_school_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                DB::raw('MAX(CASE when qlhs_profile_subject.profile_subject_subject_id = 69 then 1 else 0 END) as hotrokinhphi'), 
...
//---------------------------------------------------------------------HBHSDTNT------------------------------------------------------------------------
    public function getDataHBHSDTNT($school_id, $year, $report_name, $user_sign, $user_create, $note, $status){
        ...
        try {
            ...
            ->leftJoin('qlhs_tonghopchedo as yearold', 'yearold.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearold.qlhs_thcd_nam = '.($year - 1).' and (yearold.ThamDinh_trangthai_HBHSDTNT = 1 or yearold.ThamDinh_trangthai_HBHSDTNT_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearcur', 'yearcur.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearcur.qlhs_thcd_nam = '.$year.' and (yearcur.ThamDinh_trangthai_HBHSDTNT = 1 or yearcur.ThamDinh_trangthai_HBHSDTNT_HK2 = 1)'))
            ->leftJoin('qlhs_tonghopchedo as yearnew', 'yearnew.qlhs_thcd_profile_id', '=', DB::raw('profile_id AND yearnew.qlhs_thcd_nam = '.($year + 1)))
            ->where('qlhs_profile.profile_school_id', '=', $school_id)
            ->where('qlhs_profile.profile_year', '<', $year.'-06-01')
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_school_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                ...
                DB::raw('(CASE when qlhs_profile_history.level_new <> "" and qlhs_profile.profile_year < "'.($year + 1).'-12-31" and (qlhs_profile.profile_leaveschool_date is null or ( qlhs_profile.profile_leaveschool_date > "'.($year + 1).'-05-31")) then 1 else 0 END) as hocky1_new'),
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.$year.' AND kp.id_doituong = 119 AND yearold.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearold.ThamDinh_trangthai_HBHSDTNT_HK2 = 1) 
                            OR (qlhs_profile_history.level_cur <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 70
                            AND qlhs_profile.profile_year < "'.$year.'-12-31"
                            AND (
                            ...
                            AND kp.months in (9,10,11,12) and kp.years = '.$year.' AND kp.id_doituong = 119 AND yearcur.qlhs_thcd_trangthai_TD = 1 AND yearcur.ThamDinh_trangthai_HBHSDTNT = 1) THEN
                                kp.value_m
                            ELSE
                                0
                            END
                    ...
                    DB::raw('MAX(
                            ...
                            ) AND kp.months in (1,2,3,4,5) and kp.years = '.($year + 1).' AND kp.id_doituong = 119 AND yearcur.qlhs_thcd_trangthai_TD_HK2 = 1 AND yearcur.ThamDinh_trangthai_HBHSDTNT_HK2 = 1) 
                            OR (qlhs_profile_history.level_new <> ""
                            AND qlhs_profile_subject.profile_subject_subject_id = 70
                            AND qlhs_profile.profile_year < "'.($year + 1).'-12-31"
                            AND (
            ...
            ->where('qlhs_profile.profile_year', '>', $year.'-05-31')
            ->where('qlhs_profile.profile_year', '<', ($year + 1).'-06-01')
            // ->where('yearcur.qlhs_thcd_nam', '=', DB::raw($year.' and (yearcur.ThamDinh_trangthai_HBHSDTNT = 1 or yearcur.ThamDinh_trangthai_HBHSDTNT_HK2 = 1)'))
            ->select('qlhs_profile.profile_id', 'qlhs_profile.profile_school_id', 'qlhs_profile.profile_year', 'qlhs_profile_history.level_old', 'qlhs_profile_history.level_cur', 'qlhs_profile_history.level_new', 'qlhs_profile.profile_leaveschool_date', 'kp.value_m', 'kp.id_doituong', 'kp.months', 'kp.years', 
                DB::raw('MAX(CASE when qlhs_profile_subject.profile_subject_subject_id = 70 then 1 else 0 END) as hotrokinhphi'), 
